...
class BS:
    def __init__(self, idBS: int, coord):
        ...
        self.nbNode = 76
        self.agent = DQNAgent(gamma=0, epsilon=1, lr=0.00005, n_actions=len(self.combinations), input_dims=(6,),
    ...
    def recommandation(self, param1, param2, param3,node, reward):
        ...
        state = np.array([param1carre, param2carre, param1, param2, param3, param1carre*param2carre])
        if self.first[node]:
