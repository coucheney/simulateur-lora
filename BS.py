...
class BS:
    def __init__(self, idBS: int, coord):
        ...
        self.nbNode = 76
        self.agent = DQNAgent(gamma=0, epsilon=0, lr=0.00008, n_actions=len(self.combinations), input_dims=(7,),
    ...
    def recommandation(self, param1, param2, param3,node, reward):
        ...
        state = np.array([param1carre, param2carre, param1, param2, param3, np.cos(param1), np.cos(param2)])
        if self.first[node]:
